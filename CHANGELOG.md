...
- 优化部分涉及全局api的代码，使用/_@**PURE**_/防止rollup等打包工具在未导入相关api时依旧会打包部分代码 ([a14d3bd](https://github.com/Xli33/utils-where/commit/a14d3bdb474230933a1f4d733d6a4464814535d2))
