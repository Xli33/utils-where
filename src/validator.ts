 ...
 * @returns boolean
 */
export const checkMobile = (val: string, lazy?: boolean) => {
 ...
 * @returns boolean
 */
export const checkTel = (val: string) => {
  if (typeof val !== 'string') val = val + '';
 ...
 * @returns boolean
 */
export const checkMail = (val: string) => {
  if (typeof val !== 'string') val = val + '';
 ...
 * @returns boolean
 */
export const checkHKMP = (val: string) => {
  if (typeof val !== 'string') val = val + '';
 ...
 * @returns boolean
 */
export const checkUnifiedIdeograph = (val: string) => {
  if (typeof val !== 'string') val = val + '';
 ...
 * @returns boolean
 */
export const checkLongitude = (val: string) => {
  if (typeof val !== 'string') val = val + '';
 ...
 * @returns boolean
 */
export const checkLatitude = (val: string) => {
  if (typeof val !== 'string') val = val + '';
